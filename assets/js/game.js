...
var fight = function(enemy) {
    ...
    while(playerInfo.health > 0 && enemy.health > 0) {
        if (isPlayerTurn) {
            // ask if player wants to fight or skip using fightOrSkip function
            if (fightOrSkip()) {
            ...
            // remove enemy's health by subtracting the amount set in the damage value
...
var startGame = function() {
    ...
    for (var i = 0; i <enemyInfo.length; i++) {
        if (playerInfo.health > 0) {
            ...
            //reset enemy.health before starting new fight. Health is randomly chosen between 40 and 60 points.
